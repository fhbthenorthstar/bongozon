import { treatmentBlogs } from "@/src/utils";
import { format, parseISO } from "date-fns";
import Image from "next/image";
import SectionHeading from "../utils/section-heading";
import Link from "next/link";

const TreatmentPosts = ({ blogs }) => {
  const posts = treatmentBlogs(blogs);
  console.log(posts);
  return (
     <section className="w-full">
     <SectionHeading heading="Tote Bags"/>
      {/* Fix the grid below */}
